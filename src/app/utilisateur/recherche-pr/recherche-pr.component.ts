...
@Component({
  selector: 'app-recherche-pr',
  templateUrl: './recherche-pr.component.html',
  styleUrls: ['./recherche-pr.component.css']
})
export class RecherchePrComponent implements OnInit {
  ...
  constructor(private router: Router,
              ...
              private listeService1: ListeService, private translate: TranslateService) {
